...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<CustomObject>> {
     ...
     * JSON DATA SOURCE
     */
    final String url = "https://min-api.cryptocompare.com/data/pricemultifull?fsyms=BTC,ETH&" +
            "tsyms=USD,EUR,NGN,KRW,HKD,ZWD,NZD,CAD,BRL,AUD,SEK,ZAR,MXN,RUB,GBP,JPY,CNY,PLN,CZK,DKK";
...
//                    List<CustomObject> objectList = ReadingJson.loadingJson(getApplicationContext(), data);
    ...
    TextView currency_symbol, currency_symbol2, btc_currency, eth_currency;
    Spinner spinner;
